...
import com.example.myapplication5.util.DateUtil;
import com.example.myapplication5.util.FileUtil;
...
public class TextWriteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 获取当前App的私有存储目录
        mPath = Objects.requireNonNull(getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS)).toString() + "/";
    }
